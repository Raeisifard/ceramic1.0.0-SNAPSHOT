...
public class EventBusBridgeVerticle extends AbstractVerticle {
  ...
  private String inboundAddress, outboundAddress;
  ...
  public void start(Promise<Void> startPromise){
    ...
    inboundAddress = config().getString("inboundAddress");
    outboundAddress = config().getString("outboundAddress");
    ...
    main.mountSubRouter("/eventbus", router);
    // start server
